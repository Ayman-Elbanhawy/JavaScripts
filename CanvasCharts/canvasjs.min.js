...
(function() {
	...
	function Xa(h, n, F) {
		"millisecond" === F ? h.setMilliseconds(h.getMilliseconds() + 1 * n) : "second" === F ? h.setSeconds(h.getSeconds() + 1 * n) : "minute" === F ? h.setMinutes(h.getMinutes() + 1 * n) : "hour" === F ? h.setHours(h.getHours() + 1 * n) : "day" === F ? h.setDate(h.getDate() + 1 * n) : "week" === F ? h.setDate(h.getDate() + 7 * n) : "month" === F ? h.setMonth(h.getMonth() + 1 * n) : "year" === F && h.setFullYear(h.getFullYear() + 1 * n);
		return h
	}
	...
	function gb(h) {
		if(T.fSDec) h[ka("`eeDwdouMhrudods")](ka("e`u`@ohl`uhnoHuds`uhnoDoe"), function() {
			T._fTWm && T._fTWm(h)
		})
	}
	...
	function J(h, n, F, w, ba) {
		...
		w.push([h, n, F, ba]);
		return h.addEventListener ? (h.addEventListener(n, F, ba), F) : h.attachEvent ? (w = function(n) {
			n = n || window.event;
	...
	function ib(h) {
		if(h._menuButton) h.exportEnabled ? (U(h._menuButton, {
			backgroundColor: h.toolbar.itemBackgroundColor,
			color: h.toolbar.fontColor
		}), Ma(h._menuButton), h._menuButton.title = h._cultureInfo.menuText) : wa(h._menuButton);
		...
		if(h.exportEnabled && h._dropdownMenu) {
			...
			for(var F = h._dropdownMenu.childNodes, q = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], ba = 0; ba < F.length; ba++) U(F[ba], {
				backgroundColor: h.toolbar.itemBackgroundColor,
				color: h.toolbar.fontColor
			}), F[ba].innerHTML = q[ba]
		...
		}, h.allDOMEventHandlers, !0), F = document.createElement("div"), U(F, {
			padding: "12px 8px 12px 8px"
		}), F.innerHTML = h._cultureInfo.printText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F), J(F, "touchstart", function(h) {
			n = !0
	...
	function xa(h, n, q) {
		...
		n.getAttribute("state") !== q && (n.setAttribute("state", q), n.setAttribute("type", "button"), U(n, {
			padding: "5px 12px",
			cursor: "pointer",
			"float": "left",
			width: "40px",
			...
			lineHeight: "0"
		}), n.setAttribute("title", h._cultureInfo[q + "Text"]), n.innerHTML = "<img src='" + lb[q].image + "' alt='" + h._cultureInfo[q + "Text"] + "' />", U(n.childNodes[0], {
			height: "95%",
			pointerEvents: "none"
		}))
	}
	...
	function V(h, n, F, w, ba) {
		...
		h = {};
		this.theme && q(this.parent) && q(n) && q(w) ? h = q(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[n]) && (null === w ? h = this.parent.themeOptions[n] : 0 < this.parent.themeOptions[n].length && (w = Math.min(this.parent.themeOptions[n].length - 1, w), h = this.parent.themeOptions[n][w]));
		this.themeOptions = h;
		this.options = F ? F : {
			_isPlaceholder: !0
		};
	...
	function za(h, n) {
		...
		if(q(this.options.margin) && h.options.subtitles)
			for(var F = h.options.subtitles, w = 0; w < F.length; w++)
				if((q(F[w].horizontalAlign) && "center" === this.horizontalAlign || F[w].horizontalAlign === this.horizontalAlign) && (q(F[w].verticalAlign) && "top" === this.verticalAlign || F[w].verticalAlign === this.verticalAlign) && !F[w].dockInsidePlotArea === !this.dockInsidePlotArea) {
					this.margin = 0;
					break
				}
	...
	var ha = 20,
		...
		Y = function(h, n, q) {
				...
				if(n = R.pop(), "#" === n || "0" === n)
					if(I++, I === O) {
						var Z = A,
							A = [];
						if("0" === n)
							for(n = O - J - (Z ? Z.length : 0); 0 < n;) Z.unshift("0"),
								n--;
			...
			else "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? "," === n ? (N++, C = T, T = 0, 0 < A.length && (q = v + q)) : q = 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? n.slice(1, n.length - 1) + q : n + q : (n = 0 > U ? n.replace("+", "").replace("-", "") : n.replace("-", ""), q += n.replace(/[0]+/, function(a) {
				return aa(U, a.length)
			}));
			v = "";
			for(R = !1; 0 < P.length;) n = P.shift(), "#" === n || "0" === n ? 0 < h.length && 0 !== Number(h.join("")) ? (v += h.shift(), R = !0) : "0" === n && (v += "0", R = !0) : 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? v += n.slice(1, n.length - 1) : "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? v += n : (n = 0 > U ? n.replace("+", "").replace("-", "") : n.replace("-", ""), v += n.replace(/[0]+/, function(a) {
				return aa(U, a.length)
			}));
			q += (R ? ba : "") + v;
			return w ? "-" + q : q
		...
		ca = function(h, n, q, w, v, C, A, I, O, R, T, P, J) {
			...
			h.restore();
			!0 === O && (h.save(), h.beginPath(), h.moveTo(n, q), h.lineTo(n + K, q + K), h.lineTo(w - K, q + K), h.lineTo(w, q), h.closePath(), A = h.createLinearGradient((w + n) / 2, q + K, (w + n) / 2, q), A.addColorStop(0, C), A.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = A, h.fill(), h.restore());
			!0 === R && (h.save(), h.beginPath(), h.moveTo(n, v), h.lineTo(n + K, v - K), h.lineTo(w - K, v - K), h.lineTo(w, v), h.closePath(), A = h.createLinearGradient((w + n) / 2, v - K, (w + n) / 2, v), A.addColorStop(0, C), A.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = A, h.fill(), h.restore());
			!0 === T && (h.save(), h.beginPath(), h.moveTo(n, q), h.lineTo(n + K, q + K), h.lineTo(n + K, v - K), h.lineTo(n, v), h.closePath(), A = h.createLinearGradient(n + K, (v + q) / 2, n, (v + q) / 2), A.addColorStop(0, C), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, h.fill(), h.restore());
			!0 === P && (h.save(), h.beginPath(), h.moveTo(w, q), h.lineTo(w - K, q + K), h.lineTo(w - K, v - K), h.lineTo(w, v), A = h.createLinearGradient(w - K, (v + q) / 2, w, (v + q) / 2), A.addColorStop(0, C), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, A.addColorStop(0, C), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, h.fill(), h.closePath(), h.restore())
		},
		ka = function(h) {
			for(var n = "", q = 0; q < h.length; q++) n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(q));
			return n
		},
		db = window && window[ka("mnb`uhno")] && window[ka("mnb`uhno")].href && window[ka("mnb`uhno")].href.indexOf && (-1 !== window[ka("mnb`uhno")].href.indexOf(ka("b`ow`rkr/bnl")) || -1 !== window[ka("mnb`uhno")].href.indexOf(ka("gdonqhy/bnl")) || -1 !== window[ka("mnb`uhno")].href.indexOf(ka("gheemd"))),
	...
	V.prototype.updateOption = function(h) {
		...
		var n = ra[this._defaultsKey],
			...
			I = this._index;
		this.theme && q(this.parent) && q(C) && q(I) ? w = q(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[C]) && (null === I ? w = this.parent.themeOptions[C] : 0 < this.parent.themeOptions[C].length && (w = Math.min(this.parent.themeOptions[C].length - 1, I), w = this.parent.themeOptions[C][w]));
		this.themeOptions = w;
	...
	V.prototype.addEventListener = function(h, n, q) {
		h && n && (this._eventListeners[h] = this._eventListeners[h] || [], this._eventListeners[h].push({
			context: q || this,
			eventHandler: n
		}))
	};
	...
	ja.prototype._initialize = function() {
		q(this.padding) || "object" !== typeof this.padding ? this.topPadding = this.rightPadding = this.bottomPadding = this.leftPadding = Number(this.padding) | 0 : (this.topPadding = q(this.padding.top) ? 0 : Number(this.padding.top) | 0, this.rightPadding = q(this.padding.right) ? 0 : Number(this.padding.right) | 0, this.bottomPadding = q(this.padding.bottom) ? 0 : Number(this.padding.bottom) | 0, this.leftPadding = q(this.padding.left) ? 0 : Number(this.padding.left) | 0)
	};
	...
	za.prototype.setLayout = function() {
		if(this.text) {
			var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
				...
				K, J;
			"top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = n.width - 4 - A * ("center" === this.horizontalAlign ? 2 : 1)), I = 0.5 * n.height - this.margin - 2, C = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = n.height - 4), I = 0.5 * n.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = n.width - 4), I = 0.5 * n.height - 4));
			var R;
			q(this.padding) || "number" !== typeof this.padding ? q(this.padding) || "object" !== typeof this.padding || (R = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, R += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : R = 2 * this.padding;
			...
			R = I.measureText();
			"top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (v = n.y1 + 2, J = "top") : "bottom" === this.verticalAlign && (v = n.y2 - 2 - R.height, J = "bottom"), "left" === this.horizontalAlign ? w = n.x1 + 2 : "center" === this.horizontalAlign ? w = n.x1 + n.width / 2 - R.width / 2 : "right" === this.horizontalAlign && (w = n.x2 - 2 - R.width - A), K = this.horizontalAlign, this.width = R.width, this.height = R.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (w = n.x1 + 2, v = n.y2 - 2 - (this.maxWidth / 2 - R.width / 2), C = -90, J = "left", this.width = R.height, this.height = R.width) : "right" === this.horizontalAlign ? (w = n.x2 - 2, v = n.y1 + 2 + (this.maxWidth / 2 - R.width / 2), C = 90, J = "right", this.width = R.height, this.height = R.width) : "center" === this.horizontalAlign && (v = h.y1 + (h.height / 2 - R.height / 2), w = h.x1 + (h.width / 2 - R.width / 2), J = "center", this.width = R.width, this.height = R.height), K = "center");
			I.x = w;
			I.y = v;
			I.angle = C;
			I.horizontalAlign = K;
	...
	v = Qa.Chart = function() {
		...
		function n(a, d, c) {
			d = d || {};
			q(c) ? (this.predefinedThemes = cb, this.optionsName = this.parent = this.index = null) : (this.parent = c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName = c.optionsName, this.stockChart = c.stockChart, this.panel = a, this.isOptionsInArray = c.isOptionsInArray);
		...
		function v(a, d) {
			for(var c = [], b, e = 0; e < a.length; e++)
				if(0 == e) c.push(a[0]);
					...
					var B = (a[l].x - a[f].x) / b;
					b = (a[l].y - a[f].y) / b;
					c[c.length] = a[s].x > a[f].x && 0 < B || a[s].x < a[f].x && 0 > B ? {
						x: a[s].x + B / 3,
						y: a[s].y + b / 3
					} : {
						x: a[s].x,
		...
		function C(a, d, c, b, e, f, l, s, B, k) {
			...
			a.beginPath();
			B && 0 < s.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p), a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - p)) : 0 < s.thickness && (a.moveTo(Math.round((d + b) / 2) - p, c + l.thickness / 2), a.lineTo(Math.round((d + b) / 2) - p, e - l.thickness / 2));
			a.stroke();
			...
			if(this.options.data) {
				for(var c = 0; c < this.options.data.length; c++)
					if(a++, !this.options.data[c].type || 0 <= n._supportedChartTypes.indexOf(this.options.data[c].type)) {
						...
						"error" === b.type && (b.linkedDataSeriesIndex = q(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex, 0 > b.linkedDataSeriesIndex || b.linkedDataSeriesIndex >= this.options.data.length || "number" !== typeof b.linkedDataSeriesIndex || "error" === this.options.data[b.linkedDataSeriesIndex].type) && (b.linkedDataSeriesIndex = null);
			...
			if(a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
				for(var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
					var s = this.data[a.dataSeriesIndexes[l]],
						...
						m = !1,
						p;
					if("normal" === s.axisPlacement || "xySwapped" === s.axisPlacement) var r = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity,
					...
					for(B = 0; B < s.dataPoints.length; B++) {
						...
						if(0 < B) {
							...
							null !== e && null !== s.dataPoints[B - 1].y && (a.axisY.logarithmic ? (t = e / s.dataPoints[B - 1].y, 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - s.dataPoints[B - 1].y, 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)))
						}
						if(b < r && !k) null !== e && (p = b);
						else {
							if(!k && (k = !0, 0 < B)) {
		...
		n.prototype._processStackedPlotUnit = function(a) {
			if(a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
				for(var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], s = [], B = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
					...
					for(r = 0; r < p.dataPoints.length; r++) {
						...
						if(0 < r) {
							...
							null !== e && null !== p.dataPoints[r - 1].y && (a.axisY.logarithmic ? 0 < e && (y = e / p.dataPoints[r - 1].y, 1 > y && (y = 1 / y), d.minDiff > y && 1 !== y && (d.minDiff = y)) : (y = e - p.dataPoints[r - 1].y, 0 > y && (y *= -1), d.minDiff > y && 0 !== y && (d.minDiff = y)))
						}
						if(b < da && !g) null !== p.dataPoints[r].y && (h = b);
							...
							b < c.viewPortMin && (c.viewPortMin = b);
							b > c.viewPortMax && (c.viewPortMax = b);
							null === p.dataPoints[r].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l[b] ? l[b] += e : (l[b] = e, B = Math.min(e, B)) : s[b] ? s[b] += e : (s[b] = e, k = Math.max(e, k)))
						}
					}
				...
				for(r in l) l.hasOwnProperty(r) && !isNaN(r) && (a = l[r], a < d.min && (d.min = Math.min(a, B)), a > d.max && (d.max = a), r < c.viewPortMin || r > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, B)), a > d.viewPortMax && (d.viewPortMax = a)));
				for(r in s) s.hasOwnProperty(r) && !isNaN(r) && (a = s[r], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), r < c.viewPortMin || r > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))))
			}
		};
			...
			if(a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
				for(var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, s = !1, B = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
					...
					if("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
						da = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
					...
					for(p = 0; p < m.dataPoints.length; p++) {
						...
						if(0 < p) {
							...
							q(e) || null === m.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < e && (u = e / m.dataPoints[p - 1].y, 1 > u && (u = 1 / u), d.minDiff > u && 1 !== u && (d.minDiff = u)) : (u = e - m.dataPoints[p - 1].y, 0 > u && (u *= -1), d.minDiff > u && 0 !== u && (d.minDiff = u)))
						}
						if(b < h && !r) null !== e && (t = b);
						else {
							if(!r && (r = !0, 0 < p)) {
							...
							b < c.viewPortMin && (c.viewPortMin = b);
							b > c.viewPortMax && (c.viewPortMax = b);
							null === e ? c.viewPortMin === b && t < b && (c.viewPortMin = t) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (s = !0), B[b] = B[b] ? B[b] + Math.abs(e) : Math.abs(e))
						}
					}
					m.axisX.valueType = m.xValueType = f ? "dateTime" : "number"
				}
				a.axisY.logarithmic ? (d.max = q(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = q(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && !s ? (d.max = q(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = q(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && s ? (d.max = q(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = q(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !l && s && (d.max = q(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = q(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
				d.viewPortMin = d.min;
				d.viewPortMax = d.max;
				a.dataPointYSums = B
			}
			...
			if(a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
				for(var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, s = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
					var k = this.data[a.dataSeriesIndexes[B]],
						...
						r = !1,
						g, t, h;
					if("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity,
						u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
					...
					for(m = 0; m < k.dataPoints.length; m++) {
						...
						f < d.min && (d.min = f);
						l > d.max && (d.max = l);
						0 < m && (a.axisX.logarithmic ? (t = b / k.dataPoints[m - 1].x, 1 > t && (t = 1 / t), c.minDiff > t && 1 !== t && (c.minDiff = t)) : (t = b - k.dataPoints[m - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t)), e && (null !== e[0] && k.dataPoints[m - 1].y && null !== k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (t = e[0] / k.dataPoints[m - 1].y[0], 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e[0] - k.dataPoints[m - 1].y[0], 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t))));
						if(!(b < q) || p) {
							if(!p && (p = !0, 0 < m)) {
								m -= 2;
								g = h;
			...
			if("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
				for(var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
					...
					if("normal" === s.axisPlacement || "xySwapped" === s.axisPlacement) var r = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity,
						g = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
					if(s.dataPoints[B].x && s.dataPoints[B].x.getTime || "dateTime" === s.xValueType) f = !0;
					for(B = 0; B < s.dataPoints.length; B++) "undefined" !== typeof s.dataPoints[B].isCumulativeSum && !0 === s.dataPoints[B].isCumulativeSum ? (s.dataPointEOs[B].cumulativeSumYStartValue = 0, s.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum, s.dataPoints[B].y = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum) : "undefined" !== typeof s.dataPoints[B].isIntermediateSum && !0 === s.dataPoints[B].isIntermediateSum ? (s.dataPointEOs[B].cumulativeSumYStartValue = p, s.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum, s.dataPoints[B].y = 0 === B ? 0 : b, p = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum, b = 0) : (e = "number" !== typeof s.dataPoints[B].y ? 0 : s.dataPoints[B].y, s.dataPointEOs[B].cumulativeSumYStartValue = 0 === B ? 0 : s.dataPointEOs[B - 1].cumulativeSum, s.dataPointEOs[B].cumulativeSum = 0 === B ? e : s.dataPointEOs[B - 1].cumulativeSum + e, b += e);
					for(B = 0; B < s.dataPoints.length; B++)
						if("undefined" === typeof s.dataPoints[B].x && (s.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)), s.dataPoints[B].x.getTime ? (f = !0, b = s.dataPoints[B].x.getTime()) : b = s.dataPoints[B].x, e = s.dataPoints[B].y, b < c.min && (c.min = b), b > c.max && (c.max = b), s.dataPointEOs[B].cumulativeSum < d.min && (d.min = s.dataPointEOs[B].cumulativeSum), s.dataPointEOs[B].cumulativeSum > d.max && (d.max = s.dataPointEOs[B].cumulativeSum), 0 < B && (a.axisX.logarithmic ? (p = b / s.dataPoints[B - 1].x, 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - s.dataPoints[B - 1].x, 0 > p && (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)), null !== e && null !== s.dataPoints[B - 1].y && (a.axisY.logarithmic ? (e = s.dataPointEOs[B].cumulativeSum / s.dataPointEOs[B - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = s.dataPointEOs[B].cumulativeSum - s.dataPointEOs[B - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < r) || k) {
							if(!k && (k = !0, 0 < B)) {
								B -= 2;
								continue
							}
							...
							b < c.viewPortMin && (c.viewPortMin = b);
							b > c.viewPortMax && (c.viewPortMax = b);
							0 < B && (s.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = s.dataPointEOs[B - 1].cumulativeSum), s.dataPointEOs[B - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = s.dataPointEOs[B - 1].cumulativeSum));
		...
		n.prototype.calculateAutoBreaks = function() {
						...
						for(var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, k = f.min, l = f.max, m = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, r, s = 0, B = 0; B < a.dataSeriesIndexes.length; B++) {
							...
							if(!(4 > h.dataPoints.length))
								for(s = 0; s < h.dataPoints.length; s++)
									if(b && (r = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[s].x.getTime ? h.dataPoints[s].x.getTime() : h.dataPoints[s].x, r = Math.floor((g - k) / r), g < f[r].min && (f[r].min = g), g > f[r].max && (f[r].max = g)), c) {
			...
			if(f) {
				for(l = 0; l < this.plotInfo.plotTypes.length; l++)
					for(f = this.plotInfo.plotTypes[l], s = 0; s < f.plotUnits.length; s++) b = f.plotUnits[s], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b);
		...
		n.prototype.validateRegion = function(a, d, c, b, e) {
			e = e || !1;
			for(var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), s = !1, B = [], k = [], m = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type && f || "axisY" === this._axes[p].type && l) && k.push(this._axes[p]);
			for(l = 0; l < k.length; l++) {
				var p = k[l],
					f = !1,
					r = p.convertPixelToValue({
						x: a,
						y: d
					}),
				...
				if(r > g) var t = g,
					...
					r = t;
				if(p.scaleBreaks)
					for(t = 0; !f && t < p.scaleBreaks._appliedBreaks.length; t++) f = p.scaleBreaks._appliedBreaks[t].startValue <= r && p.scaleBreaks._appliedBreaks[t].endValue >= g;
				if(isFinite(p.dataInfo.minDiff))
					if(t = p.getApparentDifference(r, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && (p.logarithmic && t < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && t < 3 * Math.abs(p.dataInfo.minDiff)) || r < p.minimum || g > p.maximum)) B.push(p), m.push({
						val1: r,
						val2: g
					}), s = !0;
					else if(!e) {
		...
		n.prototype.renderIndexLabels = function(a) {
			...
			for(a = 0; a < this._indexLabels.length; a++) {
				var m = this._indexLabels[a],
					...
					r, g, l = ma("indexLabelFontColor", m.dataPoint, m.dataSeries),
				...
				var E = m.dataPoint.indexLabelFormatter ? m.dataPoint.indexLabelFormatter(D) : m.dataPoint.indexLabel ? this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : m.dataSeries.indexLabelFormatter ? m.dataSeries.indexLabelFormatter(D) : m.dataSeries.indexLabel ? this.replaceKeywordsWithValue(m.dataSeries.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : null;
				if(null !== E && "" !== E) {
					...
					if("normal" === this.plotInfo.axisPlacement) {
						...
						"inside" !== x ? (e = c.y1, f = c.y2, 0 < v ? (g = m.point.y + ("horizontal" === D ? t / 2 : 0) - k - s - b, g < e && (g = "auto" === x ? Math.max(m.point.y, e) + t / 2 + s : e + t / 2 + s, A = g + k > m.point.y)) : (g = m.point.y + t / 2 + s + b, g > f - k && (g = "auto" === x ? Math.min(m.point.y, f) + t / 2 - k - s : f + t / 2 - k, A = g < m.point.y))) : (e = Math.max(m.bounds.y1, c.y1), f = Math.min(m.bounds.y2, c.y2 - k + t / 2), b = 0 <= p.indexOf("range") || "error" === p ? 0 < v ? Math.max(m.bounds.y1, c.y1) + t / 2 + s : Math.min(m.bounds.y2, c.y2) + t / 2 - k + s : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + t / 2 + ("horizontal" === D ? s : 0), 0 < v ? (g = Math.max(m.point.y, b), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(m.point.y - k - s, c.y1 + s))) : (g = Math.min(m.point.y, b), g > f - k - s && ("bubble" === p || "scatter" === p) && (g = Math.min(m.point.y + s, c.y2 - k - s))), g = Math.min(g, f))
					} else 0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (x = "auto", l = 4) : 0 <= p.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" === p && (x = "inside"), g = m.point.y + t / 2 - k / 2 + s, "inside" !== x ? (e = c.x1, f = c.x2, 0 > v ? (r = m.point.x - ("horizontal" === D ? B : B - t / 2) - l - b, r < e && (r = "auto" === x ? Math.max(m.point.x, e) + l : e + l, A = r + B > m.point.x)) : (r = m.point.x + ("horizontal" === D ? 0 : t / 2) + l + b, r > f - B - l - b && (r = "auto" === x ? Math.min(m.point.x, f) - ("horizontal" === D ? B : B / 2) - l : f - B - l, A = r < m.point.x))) : (e = Math.max(m.bounds.x1, c.x1), Math.min(m.bounds.x2, c.x2), b = 0 <= p.indexOf("range") || "error" === p ? 0 > v ? Math.max(m.bounds.x1, c.x1) + t / 2 + l : Math.min(m.bounds.x2, c.x2) - B / 2 - l + ("horizontal" === D ? 0 : t / 2) : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 + ("horizontal" === D ? 0 : t / 2), r = 0 > v ? Math.max(m.point.x, b) - ("horizontal" === D ? B / 2 : 0) : Math.min(m.point.x, b) - B / 2, r = Math.max(r, e));
					"vertical" === D && (g += k - t / 2);
					h.x = r;
					h.y = g;
					h.render(!0);
					n && ("inside" !== x && (0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !A) && (0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2 || !A)) && (d.lineWidth = n, d.strokeStyle = u ? u : "gray", d.setLineDash && d.setLineDash(I(da, n)), d.beginPath(), d.moveTo(m.point.x, m.point.y), 0 <= p.indexOf("bar") || "error" === p && m.axisSwapped ? d.lineTo(r + (0 < m.direction ? -l : B + l) + ("vertical" === D ? -t / 2 : 0), g + ("vertical" === D ? -k / 2 : k / 2 - t / 2) - s) : 0 <= p.indexOf("column") || "error" === p && !m.axisSwapped ? d.lineTo(r + B / 2 - ("horizontal" === D ? 0 : t / 2), g + ("vertical" === D ? (g - k < m.point.y ? 0 : -k) + s : (g - t / 2 < m.point.y ? k : 0) - t / 2)) : d.lineTo(r + B / 2 - ("horizontal" === D ? 0 : t / 2), g + ("vertical" === D ? g - k < m.point.y ? 0 : -k : (g - t / 2 < m.point.y ? k : 0) - t / 2)), d.stroke())
				}
			}
			d = {
				source: d,
						...
						for(var D = !1, u = 0; u < m.length; u++)
							if(n = m[u].x.getTime ? m[u].x.getTime() : m[u].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !D)))
								if("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || D || q) && (c.stroke(), w && b.stroke()), D = !0;
									...
									q || D ? (!q && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(r)), c.lineTo(n, x), w && b.lineTo(n, x)) : (c.beginPath(), c.moveTo(n, x), w && (b.beginPath(), b.moveTo(n, x))), D = q = !1) : (c.lineTo(n, x), w && b.lineTo(n, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(n, x), w && (b.stroke(), b.beginPath(), b.moveTo(n, x))));
									l = {
										x: n,
										y: x
									};
									u < m.length - 1 && (h !== (m[u].lineColor || t) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(n, x), h = m[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType, c.setLineDash(I(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
						...
						for(var D = !1, u = 0; u < m.length; u++)
							if(n = m[u].getTime ? m[u].x.getTime() : m[u].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !D)))
								if("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || D || q) && (c.stroke(), w && b.stroke()), D = !0;
									...
									q || D ? (!q && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(r)), c.lineTo(n, E), c.lineTo(n, x), w && (b.lineTo(n, E), b.lineTo(n, x))) : (c.beginPath(), c.moveTo(n, x), w && (b.beginPath(), b.moveTo(n, x))), D = q = !1) : (c.lineTo(n, E), w && b.lineTo(n, E), c.lineTo(n, x), w && b.lineTo(n, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(n, x), w && (b.stroke(), b.beginPath(), b.moveTo(n, x))));
									l = {
										x: n,
										y: x
									};
									u < m.length - 1 && (h !== (m[u].lineColor || t) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(n, x), h = m[u].lineColor || t, c.strokeStyle = h, c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType, c.setLineDash(I(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
									if(0 < m[u].markerSize || 0 < k.markerSize) E = k.getMarkerProperties(u, n, x, c), f.push(E), z = O(z), w && f.push({
										x: n,
										y: x,
										ctx: b,
										type: E.type,
					...
					if(0 < m.length)
						for(n = !1, q = 0; q < m.length; q++)
							if(u = m[q].getTime ? m[q].x.getTime() : m[q].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))
								if("number" !== typeof m[q].y) 0 < q && !n && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !m[q - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = r, p = k.nullDataLineDashType) : (d(x), x = [])), n = !0;
								else {
									...
									q < m.length - 1 && (h !== (m[q].lineColor || t) || p !== (m[q].lineDashType || k.lineDashType)) && (h = m[q].lineColor || t, x[x.length - 1].newStrokeStyle = h, b.setLineDash && (m[q].lineDashType ? (p = m[q].lineDashType, x[x.length - 1].newLineDashArray = I(p, k.lineThickness)) : (p = k.lineDashType, x[x.length - 1].newLineDashArray = g)));
									...
									}(m[q].indexLabel || k.indexLabel || m[q].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
										chartType: "spline",
										dataPoint: m[q],
										dataSeries: k,
										point: {
		...
		n.prototype.renderColumn = function(a) {
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				var b = null,
					e = this.plotArea,
					f = 0,
					l, s, B, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
		...
		n.prototype.renderStackedColumn = function(a) {
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				var b = null,
					...
					B = [],
					k = 0,
					m, p, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
						...
						for(k = 0; k < u.length; k++)
							if(b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
								...
								var x = m - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
									D = x + g << 0,
									E;
								if(a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (p = a.axisY.convertValueToPixel(s[b]), E = "undefined" !== typeof f[b] ? f[b] : r, f[b] = p);
								else if(a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = u[k].y + (B[b] ? B[b] : 0), E = a.axisY.convertValueToPixel(B[b]), p = "undefined" !== typeof l[b] ? l[b] : r, l[b] = E;
								...
								(u[k].indexLabel || q.indexLabel || u[k].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
						...
						for(var n = 5 < g && q.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
							if(b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
								...
								if(a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
									...
									E = f[b] ? f[b] : r;
									f[b] = p
								} else if(a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = p + ("undefined" !== typeof B[b] ? B[b] : 0), E = a.axisY.convertValueToPixel(B[b]), p = l[b] ? l[b] : r, l[b] = E;
						...
						for(k = 0; k < u.length; k++)
							if(b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
								...
								var x = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
									D = x + g << 0,
									E;
								if(a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (E = f[b] ? f[b] : r, f[b] = m = a.axisY.convertValueToPixel(s[b]));
		...
		n.prototype.renderArea = function(a) {
			...
			function b() {
				E && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? D = x : 0 > a.axisY.viewportMaximum ? D = s.y1 : 0 < a.axisY.viewportMinimum && (D = x), f.lineTo(q, D), f.lineTo(E.x, D), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(q, D), l.lineTo(E.x, D), l.closePath(), l.fill()), f.beginPath(), f.moveTo(q, u), l.beginPath(), l.moveTo(q, u), E = {
					x: q,
					y: u
				})
			}
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				...
				for(var p = 0; p < a.dataSeriesIndexes.length; p++) {
					...
					d = !0;
					var h = 0,
						q, u, n, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
						D, E = null;
					if(0 < t.length) {
						...
						for(var ea = !0; h < t.length; h++)
							if(n = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ea)))
								if("number" !== typeof t[h].y) g.connectNullData || (ea || d) || b(), ea = !0;
									...
									d || ea ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = q, c = u, q = m.x, u = m.y, b(), f.moveTo(m.x, m.y), q = d, u = c, E = m, c = g.nullDataLineDashType, f.setLineDash(M)), f.lineTo(q, u), w && l.lineTo(q, u)) : (f.beginPath(), f.moveTo(q, u), w && (l.beginPath(), l.moveTo(q, u)), E = {
										x: q,
										y: u
									}), ea = d = !1) : (f.lineTo(q, u), w && l.lineTo(q, u), 0 == h % 250 && b());
									m = {
										x: q,
										y: u
									};
									h < t.length - 1 && (A !== (t[h].lineColor || v) || c !== (t[h].lineDashType || g.lineDashType)) && (b(), A = t[h].lineColor || v, f.strokeStyle = A, f.setLineDash && (t[h].lineDashType ? (c = t[h].lineDashType, f.setLineDash(I(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(Q))));
									...
									0 !== t[h].markerSize && (0 < t[h].markerSize || 0 < g.markerSize) && (n = g.getMarkerProperties(h, q, u, f), B.push(n), $ = O($), w && B.push({
										x: q,
										y: u,
										ctx: l,
										type: n.type,
		...
		n.prototype.renderSplineArea = function(a) {
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				...
				for(var B = 0; B < a.dataSeriesIndexes.length; B++) {
					...
					var l = [],
						r = 0,
						g, t, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
						q, u = null,
						n = [];
					if(0 < p.length) {
						...
						for(t = !1; r < p.length; r++)
							if(g = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !t)))
								if("number" !== typeof p[r].y) 0 < r && !t && (m.connectNullData ? b.setLineDash && (0 < n.length && (m.options.nullDataLineDashType || !p[r - 1].lineDashType)) && (n[n.length - 1].newLineDashArray = A, z = m.nullDataLineDashType) : (d(), n = [])), t = !0;
								else {
									...
									r < p.length - 1 && (E !== (p[r].lineColor || D) || z !== (p[r].lineDashType || m.lineDashType)) && (E = p[r].lineColor || D, n[n.length - 1].newStrokeStyle = E, b.setLineDash && (p[r].lineDashType ? (z = p[r].lineDashType, n[n.length - 1].newLineDashArray = I(z, m.lineThickness)) : (z = m.lineDashType, n[n.length - 1].newLineDashArray = C)));
					...
					if(0 < t.length) {
						...
						for(; h < t.length; h++)
							if(n = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
								var $ = u;
								"number" !== typeof t[h].y ? (g.connectNullData || (c || d) || b(), c = !0) : (q = a.axisX.convertValueToPixel(n), u = a.axisY.convertValueToPixel(t[h].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || M === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = q, c = u, q = m.x, u = m.y, b(), f.moveTo(m.x, m.y), q = d, u = c, E = m, M = g.nullDataLineDashType, f.setLineDash(Q)), f.lineTo(q, $), f.lineTo(q, u), w && (l.lineTo(q, $), l.lineTo(q, u))) : (f.beginPath(), f.moveTo(q, u), w && (l.beginPath(), l.moveTo(q, u)), E = {
									x: q,
									y: u
								}), c = d = !1) : (f.lineTo(q, $), w && l.lineTo(q, $), f.lineTo(q, u), w && l.lineTo(q, u), 0 == h % 250 && b()), m = {
									x: q,
									y: u
								}, h < t.length - 1 && (A !== (t[h].lineColor || v) || M !== (t[h].lineDashType || g.lineDashType)) && (b(), A = t[h].lineColor || v, f.strokeStyle = A, f.setLineDash && (t[h].lineDashType ? (M = t[h].lineDashType, f.setLineDash(I(M, g.lineThickness))) : (M = g.lineDashType, f.setLineDash(ea)))), n = g.dataPointIds[h], this._eventManager.objectMap[n] = {
									id: n,
									objectType: "dataPoint",
									dataSeriesIndex: r,
									dataPointIndex: h,
									x1: q,
									y1: u
								}, 0 !== t[h].markerSize && (0 < t[h].markerSize || 0 < g.markerSize) && ($ = g.getMarkerProperties(h, q, u, f), B.push($), n = O(n), w && B.push({
									x: q,
									y: u,
									ctx: l,
									type: $.type,
		...
		n.prototype.renderStackedArea = function(a) {
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				var e = null,
					...
					p = [],
					r = 0,
					g, t, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
				...
				for(D = 0; D < a.dataSeriesIndexes.length; D++) {
					...
					if(0 < m.length) {
						...
						for(var $ = !0, r = 0; r < m.length; r++) {
							var f = m[r],
								ia = null,
								ia = 0 <= z.dataPointIndexes[f] ? v[z.dataPointIndexes[f]] : {
									x: f,
									y: null
								};
							if(!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !$)))
								if("number" !== typeof ia.y) z.connectNullData || ($ || y) || d(), $ = !0;
									...
									h[f] = q - t;
									y || $ ? (!y && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || x === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (y = k.pop(), x = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(x), k.push(y), x = z.nullDataLineDashType, b.setLineDash(Q)), b.lineTo(g, t), w && n.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), w && (n.beginPath(), n.moveTo(g, t))), $ = y = !1) : (b.lineTo(g, t), w && n.lineTo(g, t), 0 == r % 250 && (d(), b.moveTo(g, t), w && n.moveTo(g, t), k.push({
										x: g,
										y: q - oa
									})));
									u = {
									...
									r < v.length - 1 && (M !== (v[r].lineColor || A) || x !== (v[r].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, t), k.push({
										x: g,
										y: q - oa
									}), M = v[r].lineColor || A, b.strokeStyle = M, b.setLineDash && (v[r].lineDashType ? (x = v[r].lineDashType, b.setLineDash(I(x, z.lineThickness))) : (x = z.lineDashType, b.setLineDash(ea))));
									...
									0 <= z.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < z.markerSize) && (oa = z.getMarkerProperties(z.dataPointIndexes[f], g, t, b), l.push(oa), f = O(C), w && l.push({
										x: g,
										y: t,
										ctx: n,
										type: oa.type,
		...
		n.prototype.renderStackedArea100 = function(a) {
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				var e = null,
					...
					p = [],
					r = 0,
					g, t, q, n, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
						...
						for(var $ = !0, r = 0; r < m.length; r++) {
							...
							if(!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !$)))
								if("number" !== typeof ia.y) z.connectNullData || ($ || n) || d(), $ = !0;
									...
									h[f] = y - t;
									n || $ ? (!n && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (n = k.pop(), u = k[k.length - 1], d(), b.moveTo(q.x, q.y), k.push(u), k.push(n), u = z.nullDataLineDashType, b.setLineDash(Q)), b.lineTo(g, t), w && x.lineTo(g, t)) : (b.beginPath(), b.moveTo(g, t), w && (x.beginPath(), x.moveTo(g, t))), $ = n = !1) : (b.lineTo(g, t), w && x.lineTo(g, t), 0 == r % 250 && (d(), b.moveTo(g, t), w && x.moveTo(g, t), k.push({
										x: g,
										y: y - na
									})));
									q = {
									...
									r < v.length - 1 && (M !== (v[r].lineColor || A) || u !== (v[r].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, t), k.push({
										x: g,
										y: y - na
									}), M = v[r].lineColor || A, b.strokeStyle = M, b.setLineDash && (v[r].lineDashType ? (u = v[r].lineDashType, b.setLineDash(I(u, z.lineThickness))) : (u = z.lineDashType, b.setLineDash(C))));
									if(0 <= z.dataPointIndexes[f]) {
									...
									0 <= z.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < z.markerSize) && (na = z.getMarkerProperties(r, g, t, b), s.push(na), f = O(G), w && s.push({
										x: g,
										y: t,
										ctx: x,
										type: na.type,
		...
		n.prototype.renderBubble = function(a) {
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				...
				for(var s = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
					for(var m = a.dataSeriesIndexes[k], p = this.data[m], r = p.dataPoints, g = 0, e = 0; e < r.length; e++) f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof r[e].z || (g = r[e].z, g > s && (s = g), g < h && (h = g));
					...
					if(0 < m.length) {
						...
						for(var p = 0, r = 0, e = 0; e < m.length; e++)
							if(f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
								...
								c.globalAlpha = 1;
								Math.sqrt((p - f) * (p - f) + (r - l) * (r - l)) < Math.min(g.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e], this._eventManager.objectMap[p] = {
									id: p,
									objectType: "dataPoint",
									dataSeriesIndex: h,
									dataPointIndex: e,
									x1: f,
									y1: l
								}, p = O(p), w && Z.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (m[e].indexLabel || k.indexLabel || m[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
									chartType: "scatter",
									dataPoint: m[e],
									dataSeries: k,
									point: {
		...
		n.prototype.renderCandlestick = function(a) {
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				var e = null,
					...
					l = this.plotArea,
					s = 0,
					h, k, m, p, r, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
				...
				for(var n = 0; n < a.dataSeriesIndexes.length; n++) {
					...
					if(0 < y.length)
						for(var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++)
							if(y[s].getTime ? g = y[s].x.getTime() : g = y[s].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !q(y[s].y) && y[s].y.length && "number" === typeof y[s].y[0] && "number" === typeof y[s].y[1] && "number" === typeof y[s].y[2] && "number" === typeof y[s].y[3]) {
								...
								"candlestick" === u.type ? (c.moveTo(h - v, m), c.lineTo(h - v, Math.min(k, r)), c.stroke(), c.moveTo(h - v, Math.max(k, r)), c.lineTo(h - v, p), c.stroke(), ca(c, D, Math.min(k, r), E, Math.max(k, r), y[s].y[0] <= y[s].y[3] ? u.risingColor : f, z, e, x, x, !1, !1, u.fillOpacity), w && (e = O(A), b.strokeStyle = e, b.moveTo(h - v, m), b.lineTo(h - v, Math.min(k, r)), b.stroke(), b.moveTo(h - v, Math.max(k, r)), b.lineTo(h - v, p), b.stroke(), ca(b, D, Math.min(k, r), E, Math.max(k, r), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(h - v, m), c.lineTo(h - v, p), c.stroke(), c.beginPath(), c.moveTo(h, k), c.lineTo(D, k), c.stroke(), c.beginPath(), c.moveTo(h, r), c.lineTo(E, r), c.stroke(), w && (e = O(A), b.strokeStyle = e, b.moveTo(h - v, m), b.lineTo(h - v, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(D, k), b.stroke(), b.beginPath(), b.moveTo(h, r), b.lineTo(E, r), b.stroke()));
		...
		n.prototype.renderBoxAndWhisker = function(a) {
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				var e = null,
					f = this.plotArea,
					l = 0,
					s, h, k, m, p, r, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
				...
				for(var n = !1, n = !!a.axisY.reversed, da = 0; da < a.dataSeriesIndexes.length; da++) {
					...
					if(0 < x.length)
						for(var D = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
							if(x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !q(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
								...
								c.save();
								0 < na && (c.beginPath(), c.strokeStyle = oa, c.lineWidth = na, c.setLineDash && c.setLineDash(I(F, na)), c.moveTo(s - G, k), c.lineTo(s - G, h), c.stroke(), c.moveTo(s - G, p), c.lineTo(s - G, m), c.stroke());
								c.restore();
								...
								c.restore();
								c.save();
								0 < Q && (c.beginPath(), c.setLineDash && c.setLineDash(I(C, Q)), c.strokeStyle = M, c.lineWidth = Q, c.moveTo(s - $ / 2 << 0, p - ia), c.lineTo(s + $ / 2 << 0, p - ia), c.stroke(), c.moveTo(s - $ / 2 << 0, h + ia), c.lineTo(s + $ / 2 << 0, h + ia), c.stroke());
								c.restore();
								w && (e = O(S), b.strokeStyle = e, b.lineWidth = na, 0 < na && (b.moveTo(s - A - G, k), b.lineTo(s - A - G, Math.max(h, p)), b.stroke(), b.moveTo(s - A - G, Math.min(h, p)), b.lineTo(s - A - G, m), b.stroke()), ca(b, E, Math.max(k, m), z, Math.min(k, m), e, 0, null, !1, !1, !1, !1), 0 < Q && (b.beginPath(), b.lineWidth = Q, b.moveTo(s + $ / 2, p - ia), b.lineTo(s - $ / 2, p - ia), b.stroke(), b.moveTo(s + $ / 2, h + ia), b.lineTo(s - $ / 2, h + ia), b.stroke()));
				...
				for(var m = 0; m < a.dataSeriesIndexes.length; m++) {
					...
					if(0 < g.length)
						for(var t = 5 < k && r.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
							if(g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !q(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
								...
								if(g[f].indexLabel || r.indexLabel || g[f].indexLabelFormatter || r.indexLabelFormatter) this._indexLabels.push({
		...
		n.prototype.renderError = function(a) {
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				var e = null,
					...
					l = this.plotArea,
					s = 0,
					h, k, m, p, r, g, t, n = a.axisX.dataInfo.minDiff;
				...
				for(var y = 0; y < a.dataSeriesIndexes.length; y++) {
					var x = a.dataSeriesIndexes[y],
						D = this.data[x],
						v = D.dataPoints,
						z = q(D._linkedSeries) ? !1 : D._linkedSeries.type.match(/(bar|column)/ig) && D._linkedSeries.visible ? !0 : !1,
						A = 0;
					if(z)
						for(e = D._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && A || (this.data[u].type.match(/(range)/ig) && (f = !0), A++);
					...
					f && (s = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? da : 1))) << 0 : 0.03 * this.width);
					...
					if(0 < v.length)
						for(var F = D._colorSet, s = 0; s < v.length; s++) {
							...
							if(!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !q(v[s].y) && v[s].y.length && "number" === typeof v[s].y[0] && "number" === typeof v[s].y[1]) {
								...
								b ? p = ea : g = ea;
								b ? (r = a.axisX.reversed ? k + (z ? da : 1) * u / 2 - (z ? A - 1 : 0) * u << 0 : k - (z ? da : 1) * u / 2 + (z ? A - 1 : 0) * u << 0, g = a.axisX.reversed ? r - u << 0 : r + u << 0) : (m = a.axisX.reversed ? h + (z ? da : 1) * u / 2 - (z ? A - 1 : 0) * u << 0 : h - (z ? da : 1) * u / 2 + (z ? A - 1 : 0) * u << 0, p = a.axisX.reversed ? m - u << 0 : m + u << 0);
								!b && r > g && (ea = r, r = g, g = ea);
								b && m > p && (ea = m, m = p, p = ea);
								ea = D.dataPointIds[s];
								...
								if(v[s].indexLabel || D.indexLabel || v[s].indexLabelFormatter || D.indexLabelFormatter) this._indexLabels.push({
									chartType: "error",
									dataPoint: v[s],
									dataSeries: D,
									indexKeyword: 0,
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				...
				for(var p = 0; p < a.dataSeriesIndexes.length; p++) {
					...
					if(0 < t.length) {
						...
						c.strokeStyle = "#4572A7 ";
						for(f = 0; f < t.length; f++)
							if(t[f].getTime ? k = t[f].x.getTime() : k = t[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !q(t[f].y) && t[f].y.length && "number" === typeof t[f].y[0] && "number" === typeof t[f].y[1]) {
						...
						for(var M = !0; g < p.length; g++)
							if(u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !M)))
								if(null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
									...
									r || M ? (m.connectNullData && !r ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = C, z = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(t, q), w && e.lineTo(t, q), h.push({
										x: t,
										y1: q,
										y2: n
									})) : (b.beginPath(), b.moveTo(t, q), y = {
										x: t,
										y: q
									}, h = [], h.push({
										x: t,
										y1: q,
										y2: n
									}), w && (e.beginPath(), e.moveTo(t, q))), M = r = !1) : (b.lineTo(t, q), h.push({
										x: t,
										y1: q,
										y2: n
									}), w && e.lineTo(t, q), 0 == g % 250 && d());
									u = m.dataPointIds[g];
									this._eventManager.objectMap[u] = {
										id: u,
										objectType: "dataPoint",
									...
									g < p.length - 1 && (E !== (p[g].lineColor || v) || z !== (p[g].lineDashType || m.lineDashType)) && (d(), E = p[g].lineColor || v, h[h.length - 1].newStrokeStyle = E, b.strokeStyle = E, b.setLineDash && (p[g].lineDashType ? (z = p[g].lineDashType, h[h.length - 1].newLineDashArray = I(z, m.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (z = m.lineDashType, h[h.length - 1].newLineDashArray = C, b.setLineDash(C))));
				...
				if(0 < d.length) {
					...
					if(0 < k.lineThickness) {
						...
						for(var g = f = 0; f < d.length - 3; f += 3, g++) {
							if(q[g].newStrokeStyle || q[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), q[g].newStrokeStyle && (b.strokeStyle = q[g].newStrokeStyle), q[g].newLineDashArray && b.setLineDash(q[g].newLineDashArray);
							b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
						}
						d = v(q, 2);
						b.moveTo(d[0].x, d[0].y);
						...
						for(g = !1; p < m.length; p++)
							if(r = m[p].x.getTime ? m[p].x.getTime() : m[p].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
								if(null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
									...
									p < m.length - 1 && (x !== (m[p].lineColor || y) || D !== (m[p].lineDashType || k.lineDashType)) && (x = m[p].lineColor || y, q[q.length - 1].newStrokeStyle = x, b.setLineDash && (m[p].lineDashType ? (D = m[p].lineDashType, q[q.length - 1].newLineDashArray = I(D, k.lineThickness)) : (D = k.lineDashType, q[q.length - 1].newLineDashArray = E)));
									...
									g = !1
								} else 0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < q.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = z, D = k.nullDataLineDashType) : (d(E, y), q = [], n = [])), g = !0;
						d(E, y);
						Z.drawMarkers(f)
					}
				}
		...
		n.prototype.renderWaterfall = function(a) {
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				var b = this._eventManager.ghostCtx,
					...
					f = this.plotArea,
					l = 0,
					h, q, k, m, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
					...
					if(0 < v.length)
						for(var x = 5 < r && n.bevelEnabled ? !0 : !1, D = !1, A = null, z = null, l = 0; l < v.length; l++)
							if(v[l].getTime ? m = v[l].x.getTime() : m = v[l].x, "number" !== typeof v[l].y) {
								...
								var Q, M = h;
								Q = "undefined" !== typeof v[l].isIntermediateSum && !0 === v[l].isIntermediateSum || "undefined" !== typeof v[l].isCumulativeSum && !0 === v[l].isCumulativeSum ? 0 < v[l].y ? q : k : 0 < v[l].y ? k : q;
								0 < l && A && (!D || n.connectNullData) && (D && c.setLineDash && c.setLineDash(I(C, u)), c.beginPath(), c.moveTo(A, z - y), c.lineTo(M, Q - y), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(A, z - y), b.lineTo(M, Q - y), 0 < u && b.stroke()));
								D = !1;
								A = F;
								z = 0 < v[l].y ? q : k;
								...
								(v[l].indexLabel || n.indexLabel || v[l].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
									chartType: "waterfall",
									dataPoint: v[l],
									dataSeries: n,
									point: {
		...
		var ra = function(a, d, c, b, e, f, l, h, q) {
			if(!(0 > c)) {
				...
				a.save();
				a.globalAlpha = h;
				"pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, l, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= q && a.arc(d.x, d.y, q * c, l, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
				a.globalAlpha = 1;
				a.restore()
			}
		};
		n.prototype.renderPie = function(a) {
			...
			function f(a, c, d) {
				...
				if(0 <= a && a < m.length) {
					...
					r = e(a);
					h = k = 0;
					0 > c ? (h = "right" === p.hemisphere ? s : r, l = c, null !== h && (s = -c, c = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height / 2), c - s < t && (k = -s, h = f(h, k, d + 1), +h.toFixed(y) > +k.toFixed(y) && (l = c > t ? -(c - t) : -(s - (h - k)))))) : 0 < c && (h = "right" === p.hemisphere ? r : s, l = c, null !== h && (s = c, c = g[h].indexLabelTextBlock.y - g[h].indexLabelTextBlock.height / 2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2), c - s < t && (k = s, h = f(h, k, d + 1), +h.toFixed(y) < +k.toFixed(y) && (l = c > t ? c - t : s - (k - h)))));
						...
						for(var s, q, a = 0; a < m.length; a++) {
							...
							if(null !== u) {
								...
								if(0 > D) {
									...
									var A = -1 * (D - q),
										I = E = 0;
									"right" === h.hemisphere ? (E = f(a, q), A = -1 * (D - E), I = f(u, A), +I.toFixed(y) < +A.toFixed(y) && +E.toFixed(y) <= +q.toFixed(y) && f(a, -(A - I))) : (E = f(u, q), A = -1 * (D - E), I = f(a, A), +I.toFixed(y) < +A.toFixed(y) && +E.toFixed(y) <= +q.toFixed(y) && f(u, -(A - I)))
								}
							}
						}
					} else
						for(a = 0; a < m.length; a++) h = g[a], w = "pie" === k.type ? 0.7 * z : 0.8 * z, u = x.x + w * Math.cos(h.midAngle), q = x.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = q;
					for(a = 0; a < m.length; a++)
						if(h = g[a], u = h.indexLabelTextBlock.measureText(), 0 !== u.height && 0 !== u.width) u = u = 0, "right" === h.hemisphere ? (u = r.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p), u *= -1) : u = r.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p), 0 < u && (!l && h.indexLabelText && (q = "right" === h.hemisphere ? r.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - r.x1, 0.3 * h.indexLabelTextBlock.maxWidth > q ? h.indexLabelText = "" : h.indexLabelTextBlock.maxWidth = 0.85 * q, 0.3 * h.indexLabelTextBlock.maxWidth < q && (h.indexLabelTextBlock.x -= "right" === h.hemisphere ? 2 : -2)), Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - x.y) < z || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - x.y) < z) && (u /= Math.abs(Math.cos(h.indexLabelAngle)), 9 < u && (u *= 0.3), u > d && (d = u)), u = u = 0, 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (u = r.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5), u *= -1) : u = r.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5), 0 < u && (!l && h.indexLabelText && (q = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1, 0 === f(a, u * q) && f(a, 2 * q)), Math.abs(h.indexLabelTextBlock.x - x.x) < z && (u /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < u && (u *= 0.3), u > d && (d = u)));
			...
			if(!(0 >= a.dataSeriesIndexes.length)) {
				var k = this.data[a.dataSeriesIndexes[0]],
					...
					D = 0;
				a = !1;
				for(var A = 0; A < m.length; A++) D += Math.abs(m[A].y), !a && ("undefined" !== typeof m[A].indexLabel && null !== m[A].indexLabel && 0 < m[A].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[A].label && null !== m[A].label && 0 < m[A].label.toString().length) && (a = !0);
				if(0 !== D) {
					...
					this.pieDoughnutClickHandler = function(a) {
						n.isAnimating || !q(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && n._animator.animate(0, 500, function(a) {
							c(a);
							h();
		...
		n.prototype.renderFunnel = function(a) {
			...
			function c() {
				...
				if(0 === g) return -1;
				for(var l = d[0] = 0, h = 0, m, p, b = b - a, l = !1, k = 0; k < y.length; k++) a = Math.abs(y[k].y) * f / g, l ? m = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = aa * aa * b * b - 4 * Math.abs(aa) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += 0 == p ? 0 : a / p, h += a / p, l = !0) : (m = (Math.abs(aa) * b - Math.sqrt(p)) / 2, p = b - 2 * m / Math.abs(aa), h += m, h > e && (h -= m, p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += a / p, h += a / p, l = !0), b = p)), d.push(m);
				return d
			}

			function b() {
				if(u && y) {
					for(var a, b, c, d, e, f, k, l, h, m, p, r, s, n, t, B = [], x = [], v = {
							percent: null,
							total: null
						}, D = null, z = 0; z < y.length; z++) t = S[z], t = "undefined" !== typeof t.x5 ? (t.y2 + t.y4) / 2 : (t.y2 + t.y3) / 2, t = g(t).x2 + 1, B[z] = J - t - W;
					t = 0.5 * W;
					for(var z = 0, E = y.length - 1; z < y.length || 0 <= E; z++, E--) {
						...
						"inside" === u.indexLabelPlacement && (B[z] = z !== ca ? u.reversed ? S[z].x2 - S[z].x1 : S[z].x3 - S[z].x4 : S[z].x3 - S[z].x6, 20 > B[z] && (B[z] = z !== ca ? u.reversed ? S[z].x3 - S[z].x4 : S[z].x2 - S[z].x1 : S[z].x2 - S[z].x1, B[z] /= 2));
						...
						if(u.indexLabelFormatter || b.indexLabelFormatter) D = {
							chart: A.options,
							dataSeries: u,
							dataPoint: b,
							total: v.total,
						...
						b = b.indexLabelFormatter ? b.indexLabelFormatter(D) : b.indexLabel ? A.replaceKeywordsWithValue(b.indexLabel, b, u, z) : u.indexLabelFormatter ? u.indexLabelFormatter(D) : u.indexLabel ? A.replaceKeywordsWithValue(u.indexLabel, b, u, z) : b.label ? b.label : "";
						0 >= m && (m = 0);
			...
			function f() {
				...
				if("inside" !== u.indexLabelPlacement)
					for(var e = 0; e < S.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = S[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > Ca ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < Ca ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + W, H[e].textBlock.y = c - H[e].height / 2, u.reversed ? (H[e].textBlock.y + H[e].height > pa + D && (H[e].textBlock.y = pa + D - H[e].height), H[e].textBlock.y < ua - D && (H[e].textBlock.y = ua - D)) : (H[e].textBlock.y < pa - D && (H[e].textBlock.y = pa - D), H[e].textBlock.y + H[e].height > ua + D && (H[e].textBlock.y = ua + D - H[e].height)));
				else
					for(e = 0; e < S.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = S[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b, H[e].textBlock.y = c) : H[e].isDirty = !0)
			}
			...
			function l() {
				...
				function b() {
					...
					for(var l, h = 1; h < k; h++) {
						e = h * f;
						for(var s = H.length - 1; 0 <= s; s--) !H[s].isDirty && (H[s].textBlock.y < e && H[s].textBlock.y + H[s].height > e) && (l = r(s), !(l >= H.length - 1) && H[s].textBlock.y + H[s].height + ba > H[l].textBlock.y && (H[s].textBlock.y = H[s].textBlock.y + H[s].height - e > e - H[s].textBlock.y ? e + 1 : e - H[s].height - 1))
					}
				...
				for(var d, e, f, g, k, l, m = 1, q = 0; q < 2 * m; q++) {
					for(var n = H.length - 1; 0 <= n && !(0 <= p(n) && p(n), f = H[n], g = f.textBlock, l = (k = r(n) < S.length ? H[r(n)] : null) ? k.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (k && e + d + ba > +l.y.toFixed(6)) && (d = g.y + d + ba - l.y, e = a(n, -d), e < d && (0 < e && (d -= e), e = a(r(n), d), e != d))); n--);
					b()
				}
			}
			...
			function n(a, b, c) {
				...
				var r = {
					...
					changeSection: function(a) {
						for(var b, c, d = 0; d < S.length; d++) b = g[d], c = S[d], b *= a, "undefined" === typeof p[d] && (p[d] = 0), 0 > p && (p *= -1), c.y1 += b - p[d], c.y2 += b - p[d], c.y3 += b - p[d], c.y4 += b - p[d], c.y5 && (c.y5 += b - p[d], c.y6 += b - p[d]), p[d] = b
					}
				};
			...
			var A = this;
			if(!(0 >= a.dataSeriesIndexes.length)) {
				for(var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, D = 0.025 * x.width, E = 0.01 * x.width, z = 0, C = x.height - 2 * D, F = Math.min(x.width - 2 * E, 2.8 * x.height), M = !1, Q = 0; Q < y.length; Q++)
					if(!M && ("undefined" !== typeof y[Q].indexLabel && null !== y[Q].indexLabel && 0 < y[Q].indexLabel.toString().length) && (M = !0), !M && ("undefined" !== typeof y[Q].label && null !== y[Q].label && 0 < y[Q].label.toString().length) && (M = !0), !M && "function" === typeof u.indexLabelFormatter || "function" === typeof y[Q].indexLabelFormatter) M = !0;
				...
				if(0 != u.length && (u.dataPoints && u.visible) && 0 !== y.length) {
					...
					a = 75 * F / 100;
					var W = 30 * (J - a) / 100;
					"funnel" === u.type ? (O = q(u.options.neckHeight) ? 0.35 * C : u.neckHeight, G = q(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" === typeof O && O.match(/%$/) ? (O = parseInt(O), O = O * C / 100) : O = parseInt(O), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), O > C ? O = C : 0 >= O && (O = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === u.type && (G = O = 0, u.reversed = u.reversed ? !1 : !0);
					var E = Q + a / 2,
						U = Q,
						X = Q + a,
						pa = u.reversed ? R : K,
					...
					if(-1 !== Q) {
						if(u.reversed)
							for(F.push(V), G = Q.length - 1; 0 < G; G--) V += Q[G], F.push(V);
						else
							for(G = 0; G < Q.length; G++) V += Q[G], F.push(V);
						if(u.reversed)
							for(G = 0; G < Q.length; G++) F[G] < Ca ? (a.push(L), E.push(Z), ca = G) : (a.push((F[G] - pa + aa * U) / aa), E.push((F[G] - pa + fa * X) / fa));
						else
							for(G = 0; G < Q.length; G++) F[G] < Ca ? (a.push((F[G] - pa + aa * U) / aa), E.push((F[G] - pa + fa * X) / fa), ca = G) : (a.push(L), E.push(Z));
						for(G = 0; G < Q.length - 1; G++) V = u.reversed ? y[y.length - 1 - G].color ? y[y.length - 1 - G].color : u._colorSet[(y.length - 1 - G) % u._colorSet.length] : y[G].color ? y[G].color : u._colorSet[G % u._colorSet.length],
							G === ca ? S.push({
								x1: a[G],
								y1: F[G],
								x2: E[G],
						...
						if(!M)
							for(G = 0; G < y.length; G++) z = u.dataPointIds[G],
								a = {
									id: z,
									objectType: "dataPoint",
									dataPointIndex: G,
		...
		n.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
			...
			return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
				...
				else return "y" === a ? Y(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? Y(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : g
			})
		};
		qa(P, V);
		P.prototype.setLayout = function() {
				...
				for(m = 0; m < n.length; m++) {
					...
					if(!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
						if("horizontal" === this.orientation) {
							...
							if(!p || p.width + Math.round(r.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) p = {
								items: [],
								width: 0
							}, k.push(p), this.height += g, g = 0;
							g = Math.max(g, r.textBlock.height)
						} else r.textBlock = new ja(this.ctx, {
							x: 0,
							y: 0,
							maxWidth: x,
							...
							fontStyle: this.fontStyle,
							textBaseline: "middle"
						}), r.textBlock.measureText(), null !== this.itemWidth && (r.textBlock.width = this.itemWidth - (w + h + ("line" === r.chartType || "spline" === r.chartType || "stepLine" === r.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < l - this.lineHeight ? (p = {
							items: [],
							width: 0
						}, k.push(p)) : (p = k[y], y = (y + 1) % k.length), this.height += r.textBlock.height;
			...
			this.items = n;
			for(m = 0; m < this.items.length; m++) r = n[m], r.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[r.id] = {
				id: r.id,
		...
		P.prototype.render = function() {
			...
			for(var h = 0, q = 0; q < l.length; q++) {
				for(var k = l[q], m = 0, p = 0; p < k.items.length; p++) {
					...
					this.ctx.clip();
					if("line" === r.chartType || "stepLine" === r.chartType || "spline" === r.chartType) this.ctx.strokeStyle = r.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, n + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, n + this.lineHeight / 2), this.ctx.stroke(), w -= 0.1 * this.lineHeight;
					...
					Z.drawMarker(g + f / 2, n + this.lineHeight / 2, this.ctx, r.markerType, "error" === r.chartType || "line" === r.chartType || "spline" === r.chartType ? r.markerSize / 2 : r.markerSize, r.markerColor, r.markerBorderColor, r.markerBorderThickness);
					r.textBlock.x = g + c + f;
					...
					if(r) {
						switch(this.type) {
							...
							case "doughnut":
								...
								n < r.radius && n > v && (n = Math.atan2(d - w.y, a - w.x), 0 > n && (n += 2 * Math.PI), n = Number(((180 * (n / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (r.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), v = Number(((180 * (r.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === v && 1 < r.endAngle && (v = 360), w >= v && 0 !== g.y && (v += 360, n < w && (n += 360)), n > w && n < v && (b.push({
									dataPoint: g,
									dataPointIndex: f,
									dataSeries: this,
									distance: 0
							...
							case "pyramid":
								n = r.funnelSection;
								d > n.y1 && d < n.y4 && (n.y6 ? d > n.y6 ? (f = n.x6 + (n.x5 - n.x6) / (n.y5 - n.y6) * (d - n.y6), n = n.x3 + (n.x4 - n.x3) / (n.y4 - n.y3) * (d - n.y3)) : (f = n.x1 + (n.x6 - n.x1) / (n.y6 - n.y1) * (d - n.y1), n = n.x2 + (n.x3 - n.x2) / (n.y3 - n.y2) * (d - n.y2)) : (f = n.x1 + (n.x4 - n.x1) / (n.y4 - n.y1) * (d - n.y1), n = n.x2 + (n.x3 - n.x2) / (n.y3 - n.y2) * (d - n.y2)), a > f && a < n && (b.push({
									dataPoint: g,
									dataPointIndex: r.dataPointIndex,
									dataSeries: this,
									distance: 0
								...
								break;
							case "boxAndWhisker":
								if(a >= r.x1 - r.borderThickness / 2 && a <= r.x2 + r.borderThickness / 2 && d >= r.y4 - r.borderThickness / 2 && d <= r.y1 + r.borderThickness / 2 || Math.abs(r.x2 - a + r.x1 - a) < r.borderThickness && d >= r.y1 && d <= r.y4) b.push({
									dataPoint: g,
									dataPointIndex: f,
									dataSeries: this,
								...
								break;
							case "candlestick":
								if(a >= r.x1 - r.borderThickness / 2 && a <= r.x2 + r.borderThickness / 2 && d >= r.y2 - r.borderThickness / 2 && d <= r.y3 + r.borderThickness / 2 || Math.abs(r.x2 - a + r.x1 - a) < r.borderThickness && d >= r.y1 && d <= r.y4) b.push({
									dataPoint: g,
									dataPointIndex: f,
									dataSeries: this,
									distance: Math.min(Math.abs(r.x1 - a), Math.abs(r.x2 - a), Math.abs(r.y2 - d), Math.abs(r.y3 - d))
								...
								break;
							case "ohlc":
								if(Math.abs(r.x2 - a + r.x1 - a) < r.borderThickness && d >= r.y2 && d <= r.y3 || a >= r.x1 && a <= (r.x2 + r.x1) / 2 && d >= r.y1 - r.borderThickness / 2 && d <= r.y1 + r.borderThickness / 2 || a >= (r.x1 + r.x2) / 2 && a <= r.x2 && d >= r.y4 - r.borderThickness / 2 && d <= r.y4 + r.borderThickness / 2) b.push({
									dataPoint: g,
									dataPointIndex: f,
									dataSeries: this,
									distance: Math.min(Math.abs(r.x1 - a), Math.abs(r.x2 - a), Math.abs(r.y2 - d), Math.abs(r.y3 - d))
		...
		A.prototype.createLabels = function() {
			...
			if("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
				...
				if(this.logarithmic && !this.equidistantInterval)
					for(this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = r; b < this.logLabelValues.length; b++)
						if(c = this.logLabelValues[b], c < this.viewportMinimum) b++;
							...
							}) : "axisX" === this.type && this.labels[m] ? this.labels[m] : Y(m, this.valueFormatString, this.chart._cultureInfo), a = new ja(this.ctx, {
								x: 0,
								y: 0,
								maxWidth: f,
								maxHeight: l,
				...
				for(this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Xa(new Date(this.viewportMaximum), this.interval, this.intervalType), g = r, c = this.intervalStartPosition; c < e; Xa(c, b, this.intervalType)) {
			...
			if("bottom" === this._position || "top" === this._position) h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * K[this.intervalType + "Duration"] * this.interval, f = "undefined" === typeof this.options.labelMaxWidth ? 0.5 * this.chart.width >> 0 : this.options.labelMaxWidth, this.chart.panEnabled || (l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
					...
					if(f = 0.9 * h >> 0, r = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
						...
						for(c = 0; c < this._labels.length; c++)
							if(!this._labels[c].breaksLabelType) {
								...
								for(var v, g = a.text.split(" "), b = 0; b < g.length; b++) m = g[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, m = this.ctx.measureText(m), m.width > r && (v = c, r = m.width)
							}
						c = 0;
								...
								if(q(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
									if(this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), m = (k - (n + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !q(this.options.labelWrap)) this.labelWrap ? q(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, r), m), this.sessionVariables.labelWrap = this.labelWrap, d && t.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle) : q(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = f, d && t.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelWrap = this.labelWrap);
										...
										if(q(this.options.labelWrap))
											if(!q(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l);
											else if(!q(d))
											if(b = t.width + d.width >> 0, g = this.labelFontSize, r < f) b - 2 * f > p && (p = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, q(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = q(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 2.2 * f && b < 2.8 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = g) : b >= 2.8 * f && b < 3.2 * f ? (this.sessionVariables.labelMaxWidth = Math.max(f, r), this.sessionVariables.labelWrap = !0, q(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = q(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (q(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = q(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = g, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelAngle = this.labelAngle));
											else if(v === c && (0 === v && r + this._labels[v + 1].textBlock.measureText().width - 2 * f > p || v === this._labels.length - 1 && r + this._labels[v - 1].textBlock.measureText().width - 2 * f > p || 0 < v && v < this._labels.length - 1 && r + this._labels[v + 1].textBlock.measureText().width - 2 * f > p && r + this._labels[v - 1].textBlock.measureText().width - 2 * f > p)) p = 0 === v ? r + this._labels[v + 1].textBlock.measureText().width - 2 * f : r + this._labels[v - 1].textBlock.measureText().width - 2 * f, this.sessionVariables.labelFontSize = q(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m;
										else if(0 === p)
											for(this.sessionVariables.labelFontSize = q(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, r), m), t = a.measureText(), b < this._labels.length - 1 && (g = b + 1, d = this._labels[g].textBlock, d.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, r), m), d = d.measureText(), t.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
						...
						for(c = 0; c < this._labels.length; c++) a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = q(this.options.labelMaxWidth) ? q(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = f : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = q(this.options.labelFontSize) ? q(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = q(this.options.labelAngle) ? q(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = q(this.options.labelWrap) ? q(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = q(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = l : this.sessionVariables.labelMaxHeight,
							a.measureText();
			else if("left" === this._position || "right" === this._position)
				if(f = q(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
					this.sessionVariables.labelFontSize = this.labelFontSize;
					this.sessionVariables.labelMaxWidth = f;
					this.sessionVariables.labelMaxHeight = l;
			...
			for(c = 0; c < this.stripLines.length; c++) {
				...
				if("outside" === f.labelPlacement) {
					...
					if("bottom" === this._position || "top" === this._position) q(f.options.labelWrap) && !q(this.sessionVariables.stripLineLabelMaxHeight) ? A = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = A = f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
					if("left" === this._position || "right" === this._position) q(f.options.labelWrap) && !q(this.sessionVariables.stripLineLabelMaxHeight) ? A = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = A = f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
					q(f.labelBackgroundColor) && (f.labelBackgroundColor = "#EEEEEE")
				} else l = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, A = q(f.options.labelWrap) || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, q(f.labelBackgroundColor) && (q(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor = w ? "transparent" : null : f.labelBackgroundColor = "#EEEEEE");
				a = new ja(this.ctx, {
					x: 0,
					y: 0,
		...
		A.setLayout = function(a, d, c, b, e, f) {
			...
			for(g = 0; g < r.length; g++)
				if(r[g] && r[g].scaleBreaks && r[g].scaleBreaks._appliedBreaks.length)
					for(var t = r[g].scaleBreaks._appliedBreaks, w = 0; w < t.length && !(t[w].startValue > r[g].viewportMaximum); w++) t[w].endValue < r[g].viewportMinimum || (q(r[g].scaleBreaks.firstBreakIndex) && (r[g].scaleBreaks.firstBreakIndex = w), t[w].startValue >= r[g].viewPortMinimum && (r[g].scaleBreaks.lastBreakIndex = w));
			for(var v = w = 0, u = 0, y = 0, x = 0, A = 0, E = 0, z, C, F = h = 0, I, Q, J, t = I = Q = J = !1, g = 0; g < r.length; g++) r[g] && r[g].title && (r[g]._titleTextBlock = new ja(r[g].ctx, {
				text: r[g].title,
				horizontalAlign: "center",
			...
			for(g = 0; g < r.length; g++)
				if(r[g].title) switch(r[g]._position) {
					case "left":
				...
				if("normal" === e) {
					for(var y = [], x = [], A = [], E = [], K = [], N = [], O = [], P = []; 4 > w;) {
						var G = 0,
							...
							Z = 0;
						if(c && 0 < c.length)
							for(A = [], g = S = 0; g < c.length; g++) A.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), S += A[g], L += c[g] && !m.isNavigator ? c[g].margin : 0;
						else A.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
						O.push(A);
						if(b && 0 < b.length)
							for(E = [], g = Z = 0; g < b.length; g++) E.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), Z += E[g], Y += b[g] ? b[g].margin : 0;
						...
						if(a && 0 < a.length)
							for(y = [], g = V = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(n - l), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ? a[g].titleMaxWidth : a[g].lineCoordinates.width), y.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), V += y[g], e += a[g] && !m.isNavigator ? a[g].margin : 0;
						else y.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
						K.push(y);
						if(d && 0 < d.length)
							for(x = [], g = X = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(n - l), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width), x.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), X += x[g], U += d[g] && !m.isNavigator ? d[g].margin : 0;
						else x.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
						N.push(x);
						if(a && 0 < a.length)
							for(g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = l, n = Math.round(f.x2 - Z - Y > m.width - p ? m.width - p : f.x2 - Z - Y), a[g]._labels && 1 < a[g]._labels.length && (h = k = 0, k = a[g]._labels[1], h = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], v = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), u = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))), !a[g] || (!a[g].labelAutoFit || q(z) || q(C) || m.isNavigator || m.stockChart) || (h = 0, 0 < a[g].labelAngle ? C + u > n && (h += 0 < a[g].labelAngle ? C + u - n - Z : 0) : 0 > a[g].labelAngle ? z - v < l && z - v < a[g].viewportMinimum && (F = l - (L + a[g].tickLength + A + z - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (C + u > n && (h = C + u / 2 - n - Z), z - v < l && z - v < a[g].viewportMinimum && (F = l - L - a[g].tickLength - A - z + v / 2)), a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h ? n -= h : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < F ? l += F : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < F && (l += F), 0 < h && (n -= h))), m.panEnabled ? V = q(m.sessionVariables.axisX.height) ? m.sessionVariables.axisX.height = V : m.sessionVariables.axisX.height : m.sessionVariables.axisX.height = V, h = Math.round(f.y2 - V - e + G), k = Math.round(f.y2), a[g].lineCoordinates.x2 = n, a[g].lineCoordinates.width = n - l, a[g].lineCoordinates.y1 = h, a[g].lineCoordinates.y2 = h + a[g].lineThickness / 2, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + y[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
								x1: l,
								y1: h,
								x2: n,
								y2: k - (V + e - y[g] - G),
						...
						if(c && 0 < c.length)
							for(g = 0; g < c.length; g++) L = m.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + X + U < Math.max(L, p) ? Math.max(L, p) : f.y1 + X + U), n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : p, k = Math.round(f.y2 - V - e - L), c[g].lineCoordinates = {
								x1: l - T,
								y1: h,
								x2: n - T,
								y2: k,
								...
								width: n - l,
								height: k - h
							}, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), T += A[g] + c[g].margin);
						if(b && 0 < b.length)
							for(g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), n = Math.round(l), L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + X + U < Math.max(L, p) ? Math.max(L, p) : f.y1 + X + U), L = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (V + e + L)), b[g].lineCoordinates = {
								...
								y2: k,
								height: Math.abs(k - h)
							}, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (E[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), b[g].bounds = {
								x1: l,
								y1: h,
								x2: n + (E[g] + W),
								y2: k,
								width: n - l,
								height: k - h
							}, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.height ? b[g].titleMaxWidth : b[g].lineCoordinates.height), W += E[g] + b[g].margin);
						if(a && 0 < a.length)
							for(g = 0; g < a.length; g++) a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (z = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, l = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position, l = a[g].getApparentDifference(a[g].viewportMinimum, l), C = a[g].logarithmic ? (1 < l ? Math.log(l) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1));
						if(d && 0 < d.length)
							for(g = 0; g < d.length; g++) d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (z = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, l = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position, l = d[g].getApparentDifference(d[g].viewportMinimum, l), C = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
						for(g = 0; g < r.length; g++) "axisY" === r[g].type && (r[g].calculateValueToPixelConversionParameters(), r[g].calculateBreaksSizeInValues());
						if(0 < w) {
							if(a && 0 < a.length)
								for(g = 0; g < a.length; g++) t = K[w - 1][g] === K[w][g] ? !0 : !1;
							else t = !0;
							if(d && 0 < d.length)
								for(g = 0; g < d.length; g++) I = N[w - 1][g] === N[w][g] ? !0 : !1;
							else I = !0;
							if(c && 0 < c.length)
								for(g = 0; g < c.length; g++) Q = O[w - 1][g] === O[w][g] ? !0 : !1;
							else Q = !0;
							if(b && 0 < b.length)
								for(g = 0; g < b.length; g++) J = P[w - 1][g] === P[w][g] ? !0 : !1;
							else J = !0
						}
						if(t && I && Q && J) break;
						w++
					...
					for(N = []; 4 > w;) {
						...
						if(m.panEnabled)
							for(g = 0; g < c.length; g++) p[g] = q(m.sessionVariables.axisY.height) ? m.sessionVariables.axisY.height = p[g] : m.sessionVariables.axisY.height;
						else
						...
						if(a && 0 < a.length)
							for(g = 0; g < a.length; g++) {
								...
								k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - T) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
								if(c && 0 < c.length)
								...
								if(b && 0 < b.length)
									for(L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (n = b[L].lineCoordinates.x1, l = n - W);
								a[g].lineCoordinates = {
									x1: n - O,
									y1: h,
									x2: n - O,
						...
						if(d && 0 < d.length)
							for(g = 0; g < d.length; g++) {
								...
								k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - T) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
								if(c && 0 < c.length)
									for(L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - V : l);
								if(b && 0 < b.length)
									for(L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (n = b[L].lineCoordinates.x2, l = n - V);
								d[g].lineCoordinates = {
									x1: n + P,
									y1: h,
									x2: n + P,
						...
						if(0 < w) {
							...
							if(c && 0 < c.length)
								for(g = 0; g < c.length; g++) Q = C[w - 1][g] === C[w][g] ? !0 : !1;
							else Q = !0;
							if(b && 0 < b.length)
								for(g = 0; g < b.length; g++) J = u[w - 1][g] === u[w][g] ? !0 : !1;
							else J = !0
						}
						if(t && I && Q && J) break;
						w++
		...
		A.prototype.calculateBreaksInPixels = function() {
			if(!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
				...
				for(var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++) a[d].endValue < this.conversionParameters.minimum || (q(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d), a[d].startValue >= this.conversionParameters.minimum && (a[d].startPixel = this.convertValueToPixel(a[d].startValue), this.scaleBreaks.lastBreakIndex = d), a[d].endValue <= this.conversionParameters.maximum && (a[d].endPixel = this.convertValueToPixel(a[d].endValue)))
			}
		};
				...
				if("left" === this._position || "right" === this._position)
					if(this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
						for(var c = [], m, h = this.viewportMaximum, n = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
							p = this._labels[k];
							if(p.position < this.viewportMinimum) break;
							p.position > this.viewportMaximum || !(k === this._labels.length - 1 || m < Math.log(h / p.position) * n) || (c.push(p), h = p.position, m = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
						}
						this._labels = c
					} else {
		...
		A.prototype.renderStripLinesOfThicknessType = function(a) {
			if(this.stripLines && 0 < this.stripLines.length && a) {
				for(var d = this, c, b = 0, e = 0, f = !1, l = !1, h = [], n = [], l = !1, b = 0; b < this.stripLines.length; b++) {
					...
					k._thicknessType === a && ("pixel" === a && (k.value < this.viewportMinimum || k.value > this.viewportMaximum || q(k.value) || isNaN(this.range)) || "value" === a && (k.startValue <= this.viewportMinimum && k.endValue <= this.viewportMinimum || k.startValue >= this.viewportMaximum && k.endValue >= this.viewportMaximum || q(k.startValue) || q(k.endValue) || isNaN(this.range)) || h.push(k))
				}
		...
		A.prototype.showCrosshair = function(a) {
			q(a) || (a < this.viewportMinimum || a > this.viewportMaximum) || ("top" === this._position || "bottom" === this._position ? this.crosshair.render(this.convertValueToPixel(a), null, a) : this.crosshair.render(null, this.convertValueToPixel(a), a))
		};
		...
		A.prototype.calculateAxisParameters = function() {
			if(this.logarithmic) this.calculateLogarithmicAxisParameters();
				...
				if("axisX" === this.type && c) {
					...
					this.intervalType || (b / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : b / 20 <= a ? (this.interval = 20, this.intervalType = "millisecond") : b / 50 <= a ? (this.interval = 50, this.intervalType = "millisecond") : b / 100 <= a ? (this.interval = 100, this.intervalType = "millisecond") : b / 200 <= a ? (this.interval = 200, this.intervalType = "millisecond") : b / 250 <= a ? (this.interval = 250, this.intervalType = "millisecond") : b / 300 <= a ? (this.interval = 300, this.intervalType = "millisecond") : b / 400 <= a ? (this.interval = 400, this.intervalType = "millisecond") : b / 500 <= a ? (this.interval = 500, this.intervalType = "millisecond") : b / (1 * K.secondDuration) <= a ? (this.interval = 1, this.intervalType = "second") : b / (2 * K.secondDuration) <= a ? (this.interval = 2, this.intervalType = "second") : b / (5 * K.secondDuration) <= a ? (this.interval = 5, this.intervalType = "second") : b / (10 * K.secondDuration) <= a ? (this.interval = 10, this.intervalType = "second") : b / (15 * K.secondDuration) <= a ? (this.interval = 15, this.intervalType = "second") : b / (20 * K.secondDuration) <= a ? (this.interval = 20, this.intervalType = "second") : b / (30 * K.secondDuration) <= a ? (this.interval = 30, this.intervalType = "second") : b / (1 * K.minuteDuration) <= a ? (this.interval = 1, this.intervalType = "minute") : b / (2 * K.minuteDuration) <= a ? (this.interval = 2, this.intervalType = "minute") : b / (5 * K.minuteDuration) <= a ? (this.interval = 5, this.intervalType = "minute") : b / (10 * K.minuteDuration) <= a ? (this.interval = 10, this.intervalType = "minute") : b / (15 * K.minuteDuration) <= a ? (this.interval = 15, this.intervalType = "minute") : b / (20 * K.minuteDuration) <= a ? (this.interval = 20, this.intervalType = "minute") : b / (30 * K.minuteDuration) <= a ? (this.interval = 30, this.intervalType = "minute") : b / (1 * K.hourDuration) <= a ? (this.interval = 1, this.intervalType = "hour") : b / (2 * K.hourDuration) <= a ? (this.interval = 2, this.intervalType = "hour") : b / (3 * K.hourDuration) <= a ? (this.interval = 3, this.intervalType = "hour") : b / (6 * K.hourDuration) <= a ? (this.interval = 6, this.intervalType = "hour") : b / (1 * K.dayDuration) <= a ? (this.interval = 1, this.intervalType = "day") : b / (2 * K.dayDuration) <= a ? (this.interval = 2, this.intervalType = "day") : b / (4 * K.dayDuration) <= a ? (this.interval = 4, this.intervalType = "day") : b / (1 * K.weekDuration) <= a ? (this.interval = 1, this.intervalType = "week") : b / (2 * K.weekDuration) <= a ? (this.interval = 2, this.intervalType = "week") : b / (3 * K.weekDuration) <= a ? (this.interval = 3, this.intervalType = "week") : b / (1 * K.monthDuration) <= a ? (this.interval = 1, this.intervalType = "month") : b / (2 * K.monthDuration) <= a ? (this.interval = 2, this.intervalType = "month") : b / (3 * K.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : b / (6 * K.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * K.yearDuration) <= a ? 1 : b / (2 * K.yearDuration) <= a ? 2 : b / (4 * K.yearDuration) <= a ? 4 : Math.floor(A.getNiceNumber(b / (a - 1), !0) / K.yearDuration), this.intervalType = "year"));
		...
		A.prototype.calculateLogarithmicAxisParameters = function() {
			...
			if(this.scaleBreaks)
				for(l = 0; l < this.scaleBreaks._appliedBreaks.length; l++)
					if((!q(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue || !q(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[l].startValue || !q(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue) && (!q(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue || !q(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[l].endValue || !q(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue)) {
			...
			if(0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
				...
				if("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
					if(b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, n = this.chart.plotArea.y2 + p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, n = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {
							...
							x2: h + p / 2,
							y2: n
						}, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, n), this.ctx.lineTo(h, n), this.ctx.lineTo(h, e);
					...
					if(e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y << 0, n = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, h = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, h = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {
							x1: b,
							y1: e - p / 2,
							x2: h,
							y2: n + p / 2
		...
		aa.prototype.showAt = function(a) {
			...
			if("xySwapped" === d.plotInfo.axisPlacement)
				...
				for(b = 0; b < d.axisY2.length; b++) this.parent === d.axisY2[b] && (d.axisY2[b]._crosshairValue = a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum ? a : null);
			for(b = 0; b < d.axisX.length; b++) a = d.axisX[b]._crosshairValue, d.axisX[b].crosshair && (d.axisX[b].crosshair.enabled && !q(a) && a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum) && (d.axisX[b].showCrosshair(a), d.axisX[b].crosshair._updatedValue = a, this === d.axisX[b].crosshair && (c = !0));
			for(b = 0; b < d.axisX2.length; b++) a = d.axisX2[b]._crosshairValue, d.axisX2[b].crosshair && (d.axisX2[b].crosshair.enabled && !q(a) && a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum) && (d.axisX2[b].showCrosshair(a), d.axisX2[b].crosshair._updatedValue = a, this === d.axisX2[b].crosshair && (c = !0));
			for(b = 0; b < d.axisY.length; b++) a = d.axisY[b]._crosshairValue,
				d.axisY[b].crosshair && (d.axisY[b].crosshair.enabled && !q(a) && a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum) && (d.axisY[b].showCrosshair(a), d.axisY[b].crosshair._updatedValue = a, this === d.axisY[b].crosshair && (c = !0));
			for(b = 0; b < d.axisY2.length; b++) a = d.axisY2[b]._crosshairValue, d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled && !q(a) && a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a), d.axisY2[b].crosshair._updatedValue = a, this === d.axisY2[b].crosshair && (c = !0));
		...
		aa.prototype.render = function(a, d, c) {
			...
			if(this.snapToDataPoint) {
				...
				if("xySwapped" === this.chart.plotInfo.axisPlacement) {
					...
					for(var C = 0; C < this.parent.dataSeries.length; C++)(v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[C], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
					v = null;
					...
					if("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
						for(var v = Math.abs(a - this.parent.convertValueToPixel(m[C].dataPoint.y[0])), u = 0, t = 0; t < m.length; t++)
							if(m[t].dataPoint.y && m[t].dataPoint.y.length)
								for(var y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, C = t);
						...
						for(var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), x = u = 0, t = C = 0; t < m.length; t++)
							if(m[t].dataPoint.y && m[t].dataPoint.y.length)
								for(y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, C = t);
						...
						for(var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), D = x = u = 0, t = 0; t < m.length; t++)
							if(m[t].dataPoint.y && m[t].dataPoint.y.length)
								for(y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, C = t);
							else x += m[t].dataPoint.y, D = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x, D = 100 * (x / m[t].dataSeries.plotUnit.dataPointYSums[D]), u = Math.abs(a - this.parent.convertValueToPixel(D)), u < v && (v = u, C = t);
					else
					...
					if("bottom" === this.parent._position || "top" === this.parent._position) {
						...
						if("rangeBar" === this.parent.dataSeries[C].type || "error" === this.parent.dataSeries[C].type) {
							...
							}) : q(this.options.label) ? Y(q(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) : this.label
							...
							k.text = this.labelFormatter ? this.labelFormatter({
								...
								crosshair: this.options,
								value: y.dataPoint.y
							}) : q(this.options.label) ? Y(q(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label
						} else if("stackedBar100" === this.parent.dataSeries[C].type) {
							v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
							D = x = u = 0;
							for(t = C; 0 <= t; t--) x += m[t].dataPoint.y, D = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x, D = 100 * (x / m[t].dataSeries.plotUnit.dataPointYSums[D]), u = Math.abs(a - this.parent.convertValueToPixel(D)), u < v && (v = u, b = t);
							...
							k.text = this.labelFormatter ? this.labelFormatter({
								...
								crosshair: this.options,
								value: D
							}) : q(this.options.label) ? Y(q(c) ? D : c, this.valueFormatString, this.chart._cultureInfo) : this.label
						...
						if(D) {
							if("axisX" === this.parent.type)
								for(t = this.parent.convertPixelToValue({
										y: d
									}), v = null, C = 0; C < this.parent.dataSeries.length; C++)(v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
									chart: this.chart,
									axis: this.parent.options,
									crosshair: this.options,
									value: y.dataPoint.x
							...
							crosshair: this.options,
							value: y.dataPoint.x
						}) : q(this.options.label) ? Ba(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
							chart: this.chart,
							axis: this.parent.options,
							crosshair: this.options,
							value: y.dataPoint.x
						}) : q(this.options.label) ? Y(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
					...
					for(C = 0; C < this.parent.dataSeries.length; C++)(v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[C], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
					if(0 === m.length) return;
					m.sort(function(a, b) {
						return a.distance - b.distance
					});
					...
					!q(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (t = this.parent.dataSeries[0].axisX.convertPixelToValue({
						x: a
					}));
					for(C = 0; C < this.parent.dataSeries.length; C++)(v = this.parent.dataSeries[C].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[C], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
					if(0 === m.length) return;
					...
					if("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type || "boxAndWhisker" === m[0].dataSeries.type)
						for(v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), t = u = 0; t < m.length; t++)
							if(m[t].dataPoint.y && m[t].dataPoint.y.length)
								for(y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, C = t);
						...
						for(v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), t = D = x = u = 0; t < m.length; t++)
							if(m[t].dataPoint.y && m[t].dataPoint.y.length)
								for(y = 0; y < m[t].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[t].dataPoint.y[y])), u < v && (v = u, C = t);
							else x += m[t].dataPoint.y, D = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x, D = 100 * (x / m[t].dataSeries.plotUnit.dataPointYSums[D]), u = Math.abs(d - this.parent.convertValueToPixel(D)), u < v && (v = u, C = t);
					else
					...
					y = m[C];
					b = 0;
					if("rangeColumn" === this.parent.dataSeries[C].type || "rangeArea" === this.parent.dataSeries[C].type || "error" === this.parent.dataSeries[C].type || "rangeSplineArea" === this.parent.dataSeries[C].type || "candlestick" === this.parent.dataSeries[C].type || "ohlc" === this.parent.dataSeries[C].type || "boxAndWhisker" === this.parent.dataSeries[C].type) {
						...
						v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
						x = u = 0;
						for(t = C; 0 <= t; t--) x += m[t].dataPoint.y, D = m[t].dataPoint.x.getTime ? m[t].dataPoint.x.getTime() : m[t].dataPoint.x, D = 100 * (x / m[t].dataSeries.plotUnit.dataPointYSums[D]),
							u = Math.abs(d - this.parent.convertValueToPixel(D)), u < v && (v = u, b = t);
						...
						this.value = D
					} else "waterfall" === this.parent.dataSeries[C].type ? (w = 1 === r.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({
						chart: this.chart,
						axis: this.parent.options,
						crosshair: this.options,
						value: y.dataSeries.dataPointEOs[y.index].cumulativeSum
					}) : q(this.options.label) ? Y(q(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum) : (w = 1 === r.lineWidth % 2 ? (q(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : q(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({
						chart: this.chart,
						axis: this.parent.options,
						crosshair: this.options,
						value: q(c) ? y.dataPoint.y : c
					}) : q(this.options.label) ? Y(q(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataPoint.y);
					f = h = w;
					b = this.chart.plotArea.x1;
					e = this.chart.plotArea.x2;
					this.bounds = {
				...
				m = null;
				if("bottom" === this.parent._position || "top" === this.parent._position) "top" === this.parent._position && k.y - k.fontSize / 2 < this.chart.bounds.y1 && (k.y = this.chart.bounds.y1 + k.fontSize / 2), "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - k.fontSize / 2 + k.measureText().height > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2), b >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && (0 < p && (r.moveTo(b, f), r.lineTo(e, h), r.stroke(), this._hidden = !1), r.restore());
				if("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "right" === this.parent._position && k.x + k.measureText().width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.measureText().width), h >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < p && (r.moveTo(b, f), r.lineTo(e, h), r.stroke(), this._hidden = !1), r.restore())
			} else {
				if("bottom" === this.parent._position || "top" === this.parent._position) b = e = n = 1 === r.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = {
					x1: b - p / 2,
					y1: f,
					x2: e + p / 2,
					y2: h
				};
				else if("left" === this.parent._position || "right" === this.parent._position) f = h = w = 1 === r.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = {
					x1: b,
					y1: f - p / 2,
					x2: e,
					y2: h + p / 2
				...
				if("xySwapped" === this.chart.plotInfo.axisPlacement)
					if("left" === this.parent._position || "right" === this.parent._position) {
						...
						}) : q(this.options.label) ? Ba(q(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
							chart: this.chart,
							axis: this.parent.options,
							crosshair: this.options,
							value: q(c) ? this.parent.convertPixelToValue(d) : c
						}) : q(this.options.label) ? Y(q(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
						...
						if("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({
							...
							crosshair: this.options,
							value: q(c) ? this.parent.convertPixelToValue(a) : c
						}) : q(this.options.label) ? Y(q(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = b - k.measureText().width / 2, k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width), k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
					} else if("bottom" === this.parent._position || "top" === this.parent._position) {
					D = !1;
					m = "";
					if(this.parent.labels)
					...
					if(D) {
						if("axisX" === this.parent.type)
							for(t = this.parent.convertPixelToValue({
								...
								crosshair: this.options,
								value: q(c) ? this.parent.convertPixelToValue(a) : c
							}) : q(this.options.label) ? q(c) ? v.dataPoint.label : c : this.label)
					} else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({
						chart: this.chart,
						axis: this.parent.options,
						crosshair: this.options,
						value: q(c) ? this.parent.convertPixelToValue(a) : c
					}) : q(this.options.label) ? Ba(q(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
						chart: this.chart,
						axis: this.parent.options,
						crosshair: this.options,
						value: q(c) ? 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" : c
					}) : q(this.options.label) ? Y(q(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
					k.x = b - k.measureText().width / 2;
					k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width);
					k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1);
					"bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
					...
					crosshair: this.options,
					value: q(c) ? this.parent.convertPixelToValue(d) : c
				}) : q(this.options.label) ? Y(q(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2, k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2), "left" === this.parent._position ? k.x = this.parent.lineCoordinates.x2 - k.measureText().width : "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2);
					...
					if("xySwapped" === this.chart.plotInfo.axisPlacement) {
						...
						if(this.chart.axisX2)
							for(v = 0; v < this.chart.axisX2.length; v++) {
								...
								k = null;
								for(b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && n.push(k));
								k = null
							}
					} else {
						n = [];
		...
		X.prototype.highlightObjects = function(a) {
			...
			if(q(this.chart.clearedOverlayedCanvas) || "toolTip" === this.chart.clearedOverlayedCanvas) this.chart.resetOverlayedCanvas(), d.clearRect(0, 0, this.chart.width, this.chart.height), this.chart.clearedOverlayedCanvas = "toolTip";
			d.save();
			...
			for(c = 0; c < a.length; c++) {
				...
				if((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
					var b = this.chart.data[e.dataSeriesIndex],
						...
						h = e.dataPointIndex;
					!1 === f.highlightEnabled || !0 !== b.highlightEnabled && !0 !== f.highlightEnabled || ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "scatter" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type ? (f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), Z.drawMarkers([f]), "undefined" !== typeof e.y2 && (f = b.getMarkerProperties(h, e.x1, e.y2, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), Z.drawMarkers([f]))) : "bubble" === b.type ? (f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = e.size, f.color = "white", f.borderColor = "white", d.globalAlpha = 0.3, Z.drawMarkers([f]), d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? ca(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? ra(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? ta(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, Math.min(e.y2, e.y3)), d.lineTo(e.x3 - b, Math.min(e.y1, e.y4)), d.stroke(), d.beginPath(), d.moveTo(e.x3 - b, Math.max(e.y1, e.y4)), d.lineTo(e.x3 - b, Math.max(e.y2, e.y3)), d.stroke(), ca(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1) : "ohlc" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, e.y2), d.lineTo(e.x3 - b, e.y3), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y1), d.lineTo(e.x1, e.y1), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4), d.lineTo(e.x2, e.y4), d.stroke(), d.globalAlpha = 1) : "boxAndWhisker" === b.type ? (d.save(), d.globalAlpha = 1, d.strokeStyle = e.stemColor, d.lineWidth = 2 * e.stemThickness, 0 < e.stemThickness && (d.beginPath(), d.moveTo(e.x3, e.y2 + e.borderThickness / 2), d.lineTo(e.x3, e.y1 + e.whiskerThickness / 2), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4 - e.whiskerThickness / 2), d.lineTo(e.x3, e.y3 - e.borderThickness / 2), d.stroke()), d.beginPath(), ca(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), "transparent", e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1, d.strokeStyle = e.whiskerColor, d.lineWidth = 2 * e.whiskerThickness, 0 < e.whiskerThickness && (d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y4), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y4), d.stroke(), d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y1), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y1), d.stroke()), d.globalAlpha = 1, d.strokeStyle = e.lineColor, d.lineWidth = 2 * e.lineThickness, 0 < e.lineThickness && (d.beginPath(), d.moveTo(e.x1, e.y5), d.lineTo(e.x2, e.y5), d.stroke()), d.restore(), d.globalAlpha = 1) : "error" === b.type && C(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
				}
			}
			d.restore();
			d.globalAlpha = 1;
		...
		X.prototype.showAtX = function(a, d) {
			...
			if(this.shared)
				for(var h = 0; h < this.chart.data.length; h++) c = this.chart.data[h], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !q(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
			else c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !q(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b));
			if(0 < f.length) {
				for(h = 0; h < f.length; h++)
					if(b = f[h], b.dataPoint.x < b.dataSeries.axisX.viewportMinimum || b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum || b.dataPoint.y > b.dataSeries.axisY.viewportMaximum) e = !0;
					else {
						e = !1;
						break
					}
